...
export const metadata = {
  ...
  description:
    "Our research fellowship supports academic and independent scholars engaged in scholarly writing, publications, media and art projects related to outdoor recreation and the outdoor industry. Topics related to diversity and sustainability in the outdoors are particularly encouraged.",
  keywords:
  ...
  openGraph: {
    ...
    type: "website",
    locale: "en_US",
    url: "https://outdoorrecreationarchive.com/research-fellowship",
    images: [
      {
